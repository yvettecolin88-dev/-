    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <div className="bg-medical-600 p-1.5 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col">
            ...
            <span className={`text-xs font-medium tracking-wide ${isScrolled ? 'text-brand-600' : 'text-brand-700'}`}>
              流浪猫救济计划
            </span>
          </div>
        </div>
        <div className="hidden md:flex items-center space-x-8">
          <a href="#about" className={`font-medium hover:text-brand-500 transition-colors ${isScrolled ? 'text-slate-600' : 'text-slate-700'}`}>关于计划</a>
          <a href="#cats" className={`font-medium hover:text-brand-500 transition-colors ${isScrolled ? 'text-slate-600' : 'text-slate-700'}`}>校园猫咪</a>
          <a href="#impact" className={`font-medium hover:text-brand-500 transition-colors ${isScrolled ? 'text-slate-600' : 'text-slate-700'}`}>资金去向</a>
          <button onClick={onVolunteerClick} className={`font-medium hover:text-brand-500 transition-colors ${isScrolled ? 'text-slate-600' : 'text-slate-700'}`}>成为志愿者</button>
        </div>
        <button 
          onClick={onDonateClick}
          className="bg-brand-500 hover:bg-brand-600 text-white px-6 py-2 rounded-full font-bold shadow-lg shadow-brand-500/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
        >
  ...
  return (
    <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-medical-50 text-medical-700 border border-medical-100 font-medium text-sm mb-6 animate-fade-in-up shadow-sm">
          <ShieldPlus className="w-4 h-4 mr-2" />
          齐齐哈尔医学院学生社团联合会认证项目
        </div>
        <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-6 leading-tight">
          弘扬医者仁心<br className="hidden md:block" />
        ...
        <p className="mt-4 text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          这里是齐齐哈尔医学院流浪动物关爱中心。寒冬将至，我们致力于为校园内的流浪猫提供食物、绝育与医疗援助。
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button 
            onClick={onDonateClick}
            className="px-8 py-4 bg-brand-600 text-white text-lg font-bold rounded-xl shadow-xl shadow-brand-500/20 hover:bg-brand-700 transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
          >
          ...
          <a 
            href="#about"
            className="px-8 py-4 bg-white text-slate-700 text-lg font-bold rounded-xl border border-slate-200 shadow-sm hover:bg-slate-50 transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
          >
            了解更多
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-slate-200 pt-8">
          {[
            ...
            <div key={idx} className="text-center group cursor-default">
              <div className="flex justify-center mb-2 text-medical-500 group-hover:scale-110 transition-transform">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="relative">
          <div className="absolute -inset-4 bg-medical-100 rounded-3xl transform -rotate-3"></div>
          <img 
          ...
          <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-slate-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-lg">定点投喂与观察</h4>
                <p className="text-slate-600 text-sm mt-1">我们在齐齐哈尔医学院内（包括图书馆后、食堂旁）设有5个固定投喂点。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <h2 className="text-brand-600 font-bold tracking-wide uppercase text-sm mb-2">关于我们</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">珍视生命，从校园开始</h3>
...
const ImpactSection = () => {
  return (
    <section id="impact" className="py-20 bg-slate-900 text-white overflow-hidden relative">
      <div className="absolute top-0 right-0 w-96 h-96 bg-brand-500/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-medical-500/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-brand-400 font-bold tracking-wide uppercase text-sm mb-2">透明公开</h2>
          <h3 className="text-3xl md:text-4xl font-bold mb-4">每一分善款的去向</h3>
          <p className="text-slate-400 max-w-2xl mx-auto">我们坚持财务公开透明，定期在校内公告栏及公众号公示收支明细。</p>
        </div>
          ...
          <div className="bg-slate-800/50 p-8 rounded-3xl border border-slate-700 backdrop-blur-sm">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-lg">齐医冬季保暖特别行动</h4>
                  <p className="text-slate-400 text-xs">截止日期: 2026-1-30</p>
                </div>
              </div>
              <span className="bg-brand-600 text-white text-xs px-3 py-1 rounded-full font-bold">进行中</span>
            </div>
            
            <h5 className="text-2xl font-bold mb-2">猫窝加固与冬粮储备</h5>
            ...
            <div className="grid grid-cols-3 gap-4 border-t border-slate-700 pt-6">
               <div className="text-center">
                 ...
                 <div className="text-xs text-slate-400 mt-1">计划升级猫窝</div>
               </div>
               <div className="text-center border-l border-slate-700">
                 <div className="text-2xl font-bold">200kg</div>
                 <div className="text-xs text-slate-400 mt-1">过冬猫粮</div>
               </div>
               <div className="text-center border-l border-slate-700">
                 <div className="text-2xl font-bold">15</div>
                 <div className="text-xs text-slate-400 mt-1">防冻水碗</div>
               </div>
            </div>
          </div>
...
const CatsGallery = ({ onDonateClick }: { onDonateClick: () => void }) => {
  const cats = [
    ...
    // Replaced "奥利奥" image with a clear Tuxedo (black and white) cat image
  ...
  return (
    <section id="cats" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">认识我们的校园伙伴</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">每一只猫都有自己的名字和故事。您的捐助将直接改变它们的命运。</p>
        </div>
          ...
          {cats.map((cat, idx) => (
            <div key={idx} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col h-full">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-slate-600 text-sm mb-6 line-clamp-3 flex-1">{cat.desc}</p>
                <button 
                  onClick={onDonateClick}
                  className="w-full py-2 rounded-lg border border-brand-200 text-brand-600 font-medium hover:bg-brand-50 transition-colors flex items-center justify-center gap-2 group-hover:bg-brand-500 group-hover:text-white group-hover:border-brand-500"
                >
    ...
    <section id="donate" className="py-20 bg-white relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-5">
            <div className="md:col-span-2 bg-slate-900 text-white p-10 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">您的爱心<br/>不仅是捐赠</h3>
            ...
            <div className="md:col-span-3 p-8 md:p-10">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">选择捐赠金额</h3>
              <form onSubmit={handleDonate}>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {presets.map((preset) => (
                    ...
                    >
                      <div className={`font-bold text-lg mb-1 ${amount === preset.value ? 'text-brand-700' : 'text-slate-800'}`}>
                        ¥{preset.value}
                      </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-xl border-2 focus:ring-0 outline-none transition-all
                        ${amount === 'custom' 
                ...
                <button 
                  ...
                  className="w-full bg-brand-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-brand-500/30 hover:bg-brand-700 transition-all hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex justify-center items-center gap-2"
                >
      ...
      {showQR && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden relative animate-scale-in flex flex-col items-center">
             <button 
             ...
             {modalStep === 'qr' ? (
               <div className="p-6 w-full flex flex-col items-center">
                  <div className="mb-4 text-center">
                     <h3 className="text-xl font-bold text-slate-900">感谢您的爱心捐赠</h3>
                     <p className="text-brand-600 font-medium">齐齐哈尔医学院流浪猫救济计划</p>
                  </div>
               ...
               <div className="p-8 w-full flex flex-col items-center text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">订单审核中</h3>
      ...
      <div className="grid md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="text-xl font-bold text-white">齐齐哈尔医学院 | 流浪猫救济计划</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#cats" className="hover:text-brand-400 transition-colors">猫咪档案</a></li>
            <li><a href="#impact" className="hover:text-brand-400 transition-colors">财务公示</a></li>
            <li><button onClick={onVolunteerClick} className="hover:text-brand-400 transition-colors text-left">加入志愿者</button></li>
          </ul>
        </div>
